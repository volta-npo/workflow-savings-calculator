...
function bindV3Static() {
  $('#v3-certify').addEventListener('click', () => { if (!confirm('Load demo sample data? This pre-fills all gates for preview only \u2014 real certification requires real evidence.')) return; state = certifyAllV3(v3, state); save(); renderV3(); });
